# nvim-treesitter-queries-xcompose

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-xcompose/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-xcompose/actions/workflows/validate.yml)

Neovim tree-sitter queries for **xcompose**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-xcompose",
...
- [ ] Changes are scoped to `xcompose` — do not include files for other languages
